...
export const SET_EVENT_RESERVATION_SECTION_TICKETS_QUERY_DATA = (
  ...
  response: Awaited<ReturnType<typeof GetReservationSectionTickets>>
) => {
  client.setQueryData(
 ...
 * @group Events
 */
export const GetReservationSectionTickets = async ({
  eventId,
 ...
 * @group Events
 */
export const useGetReservationSectionTickets = (
  eventId: string = "",
  reservationSectionId: string = "",
  params: Omit<
    InfiniteQueryParams,
  ...
  options: InfiniteQueryOptions<
    Awaited<ReturnType<typeof GetReservationSectionTickets>>
  > = {}
) => {
