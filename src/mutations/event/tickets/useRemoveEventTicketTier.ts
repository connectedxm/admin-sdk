 ...
 * @group Event-Tickets
 */
export interface RemoveEventTicketTierParams extends MutationParams {
  eventId: string;
  ticketId: string;
  tierId: string;
}
...
export const RemoveEventTicketTier = async ({
  ...
  adminApiParams,
  queryClient,
}: RemoveEventTicketTierParams): Promise<ConnectedXMResponse<EventTicket>> => {
 ...
 * @group Event-Tickets
 */
export const useRemoveEventTicketTier = (
  options: Omit<
    ConnectedXMMutationOptions<
      Awaited<ReturnType<typeof RemoveEventTicketTier>>,
      Omit<RemoveEventTicketTierParams, "queryClient" | "adminApiParams">
    >,
    "mutationFn"
  > = {}
) => {
  return useConnectedMutation<
    RemoveEventTicketTierParams,
    Awaited<ReturnType<typeof RemoveEventTicketTier>>
  >(RemoveEventTicketTier, options);
};
